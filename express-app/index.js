...
const PORT = 3000;
     ...
     //created a route method that will pass /item path and there is a get function within the route and passes the req and res
     app.route('/item')
          .get((req, res) => {
               throw new Error();   //forcing an error to happen
     ...
     //create a custom error handlling function
     //Error handling function/ 
     app.use((err, req, res , next) => {
          console.error(err.stack)  //print the error stack
